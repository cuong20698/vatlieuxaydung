...
namespace VLXD.Admin.TaiKhoan
{
    public partial class ChiTietTaiKhoan : System.Web.UI.UserControl
    {
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            bool rs = DAO.update("UPDATE dbo.NguoiDung SET TenND=N'" + txtHoten.Value + "', Email ='" + 
                        txtemail.Value + "',SDT ='" + txtsdt.Value + "',DIACHI =N'" +
                        txtdiachi.Value + "'  WHERE UserName = '" + Session["username"] + "'");
