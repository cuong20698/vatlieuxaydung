<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuenMK.aspx.cs" Inherits="VLXD.QuenMK" %>
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="/DangKy.aspx">Đăng ký tài khoản</a>
          <a class="d-block small" href="/Login.aspx">Đăng nhập</a>
        </div>
      </div>
    </div>
  </div>
